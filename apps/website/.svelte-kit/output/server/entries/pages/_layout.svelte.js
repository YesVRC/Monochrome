import { g as get_store_value, c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, d as subscribe, f as createEventDispatcher, h as spread, i as escape_object, v as validate_component, m as missing_component, j as each } from "../../chunks/index2.js";
...
${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return `
        ...
        {
          slotDefault: "h-full",
          gridColumns: "grid-cols-[1fr_3fr_1fr]",
          slotTrail: " h-full justify-center m-0"
        },
        {},
        {
          lead: () => {
            return `<a href="/"><strong class="text-xl uppercase neon-text-surface hover:neon-text-primary px-1 rounded-xl">Monochrome</strong></a>
            `;
          },
          default: () => {
            return `<div class="m-auto w-fit h-full flex flex-row text-center"><a class="cursor-pointer neon-text-surface hover:neon-text-primary p-4" href="/connect">Connect</a>
                <a class="cursor-pointer neon-text-surface hover:neon-text-primary p-4" href="/about">About</a>
                <a class="cursor-pointer neon-text-surface hover:neon-text-primary p-4" href="/events">Events</a></div>`;
          }
        }
      )}
    `;
